...
c***********************************************************************
      ...
      character etiq1(8)*60,nsat(141)*17,atmid(7)*51,reflec(8)*71
...
c***********************************************************************
     ...
     s ' GF1WFV1 1       ',' GF1WFV1 2       ',' GF1WFV1 3       ',
     s ' GF1WFV1 4       ',
	 s ' GF1WFV2 1       ',' GF1WFV2 2       ',' GF1WFV2 3       ',
     s ' GF1WFV2 4       ',
     s ' GF1WFV3 1       ',' GF1WFV3 2       ',' GF1WFV3 3       ',
     s ' GF1WFV3 4       ',
     s ' GF1WFV4 1       ',' GF1WFV4 2       ',' GF1WFV4 3       ',
     s ' GF1WFV4 4       ',	 
	 s ' GF1PMS1 pan     ',' GF1PMS1 1       ',' GF1PMS1 2       ',
     s ' GF1PMS1 3       ',' GF1PMS1 4       ',
	 s ' GF1PMS2 pan     ',' GF1PMS2 1       ',' GF1PMS2 2       ',
     s ' GF1PMS2 3       ',' GF1PMS2 4       ',
	 s ' GF2PMS1 pan     ',' GF2PMS1 1       ',' GF2PMS1 2       ',
     s ' GF2PMS1 3       ',' GF2PMS1 4       ',
     s ' GF2PMS2 pan     ',' GF2PMS2 1       ',' GF2PMS2 2       ',
     s ' GF2PMS2 3       ',' GF2PMS2 4       ',
	 s ' GF4PMI pan      ',' GF4PMI 1        ',' GF4PMI 2        ',
     s ' GF4PMI 3        ',' GF4PMI  4       ',
	 s ' GF6PMS pan      ',' GF6PMS 1        ',' GF6PMS 2        ',
     s ' GF6PMS 3        ',' GF6PMS 4        ',
	 s ' GF6WFV 1        ',' GF6WFV 2        ',' GF6WFV 3        ',
     s ' GF6WFV 4        ',' GF6WFV 5        ',' GF6WFV 6        ',
	 s ' GF6WFV 7        ',' GF6WFV 8        ',
	 s ' S2AMSI 1        ',' S2AMSI 2        ',' S2AMSI 3        ',
	 s ' S2AMSI 4        ',' S2AMSI 5        ',' S2AMSI 6        ',
	 s ' S2AMSI 7        ',' S2AMSI 8        ',' S2AMSI 8A       ',
	 s ' S2AMSI 9        ',' S2AMSI 10       ',' S2AMSI 11      ',
	 s ' S2AMSI 12       ',
	 s ' S2BMSI 1        ',' S2BMSI 2        ',' S2BMSI 3        ',
	 s ' S2BMSI 4        ',' S2BMSI 5        ',' S2BMSI 6        ',
	 s ' S2BMSI 7        ',' S2BMSI 8        ',' S2BMSI 8A       ',
	 s ' S2BMSI 9        ',' S2BMSI 10       ',' S2BMSI 11      ',
	 s ' S2BMSI 12       '/
...
c        61  GF1WFV1 band 1           ( 0.4500-0.5200)                 c
c        62  GF1WFV1 band 2           ( 0.5200-0.5900)                 c
c        63  GF1WFV1 band 3           ( 0.6300-0.6900)                 c
c        64  GF1WFV1 band 4           ( 0.7700-0.8900)                 c
c        65  GF1WFV2 band 1           ( 0.4500-0.5200)                 c
c        66  GF1WFV2 band 2           ( 0.5200-0.5900)                 c
c        67  GF1WFV2 band 3           ( 0.6300-0.6900)                 c
c        68  GF1WFV2 band 4           ( 0.7700-0.8900)                 c
c        69  GF1WFV3 band 1           ( 0.4500-0.5200)                 c
c        70  GF1WFV3 band 2           ( 0.5200-0.5900)                 c
c        71  GF1WFV3 band 3           ( 0.6300-0.6900)                 c
c        72  GF1WFV3 band 4           ( 0.7700-0.8900)                 c
c        73  GF1WFV4 band 1           ( 0.4500-0.5200)                 c
c        74  GF1WFV4 band 2           ( 0.5200-0.5900)                 c
c        75  GF1WFV4 band 3           ( 0.6300-0.6900)                 c
c        76  GF1WFV4 band 4           ( 0.7700-0.8900)                 c
c        77  GF1PMS1 band P           ( 0.4500-0.9000)                 c
c        78  GF1PMS1 band 1           ( 0.4500-0.5200)                 c
c        79  GF1PMS1 band 2           ( 0.5200-0.5900)                 c
c        80  GF1PMS1 band 3           ( 0.6300-0.6900)                 c
c        81  GF1PMS1 band 4           ( 0.7700-0.8900)                 c
c        82  GF1PMS2 band P           ( 0.4500-0.9000)                 c
c        83  GF1PMS2 band 1           ( 0.4500-0.5200)                 c
c        84  GF1PMS2 band 2           ( 0.5200-0.5900)                 c
c        85  GF1PMS2 band 3           ( 0.6300-0.6900)                 c
c        86  GF1PMS2 band 4           ( 0.7700-0.8900)                 c
c        87  GF2PMS1 band P           ( 0.4500-0.9000)                 c
c        88  GF2PMS1 band 1           ( 0.4500-0.5200)                 c
c        89  GF2PMS1 band 2           ( 0.5200-0.5900)                 c
c        90  GF2PMS1 band 3           ( 0.6300-0.6900)                 c
c        91  GF2PMS1 band 4           ( 0.7700-0.8900)                 c
c        92  GF2PMS2 band P           ( 0.4500-0.9000)                 c
c        93  GF2PMS2 band 1           ( 0.4500-0.5200)                 c
c        94  GF2PMS2 band 2           ( 0.5200-0.5900)                 c
c        95  GF2PMS2 band 3           ( 0.6300-0.6900)                 c
c        96  GF2PMS2 band 4           ( 0.7700-0.8900)                 c
c        97  GF4PMI  band P           ( 0.4500-0.9000)                 c
c        98  GF4PMI  band 1           ( 0.4500-0.5200)                 c
c        99  GF4PMI  band 2           ( 0.5200-0.5900)                 c
c        100 GF4PMI  band 3           ( 0.6300-0.6900)                 c
c        101 GF4PMI  band 4           ( 0.7600-0.9000)                 c
c        102 GF6PMS  band P           ( 0.4500-0.9000)                 c
c        103 GF6PMS  band 1           ( 0.4500-0.5200)                 c
c        104 GF6PMS  band 2           ( 0.5200-0.5900)                 c
c        105 GF6PMS  band 3           ( 0.6300-0.6900)                 c
c        106 GF6PMS  band 4           ( 0.7600-0.9000)                 c              
c        107 GF6WFV  band 1           ( 0.4500-0.5200)                 c
c        108 GF6WFV  band 2           ( 0.5200-0.5900)                 c
c        109 GF6WFV  band 3           ( 0.6300-0.6900)                 c
c        110 GF6WFV  band 4           ( 0.7700-0.8900)                 c
c        111 GF6WFV  band 5           ( 0.6900-0.7300)                 c
c        112 GF6WFV  band 6           ( 0.7300-0.7700)                 c
c        113 GF6WFV  band 7           ( 0.4000-0.4500)                 c
c        114 GF6WFV  band 8           ( 0.5900-0.6300)                 c
c        115 S2AMSI  band 1           ( 0.4322-0.4532)                 c
c        116 S2AMSI  band 2           ( 0.4594-0.5254)                 c
c        117 S2AMSI  band 3           ( 0.5418-0.5778)                 c
c        118 S2AMSI  band 4           ( 0.6491-0.6801)                 c
c        119 S2AMSI  band 5           ( 0.6966-0.7116)                 c
c        120 S2AMSI  band 6           ( 0.7330-0.7480)                 c
c        121 S2AMSI  band 7           ( 0.7728-0.7928)                 c
c        122 S2AMSI  band 8           ( 0.7798-0.8858)                 c
c        123 S2AMSI  band 8A          ( 0.8542-0.8752)                 c
c        124 S2AMSI  band 9           ( 0.9351-0.9551)                 c
c        125 S2AMSI  band 10          ( 1.3580-1.3890)                 c
c        126 S2AMSI  band 11          ( 1.5682-1.6592)                 c
c        127 S2AMSI  band 12          ( 2.1149-2.2899)                 c
c        128 S2BMSI  band 1           ( 0.4317-0.4527)                 c
c        129 S2BMSI  band 2           ( 0.4591-0.5251)                 c
c        130 S2BMSI  band 3           ( 0.5410-0.5770)                 c
c        131 S2BMSI  band 4           ( 0.6494-0.6804)                 c
c        132 S2BMSI  band 5           ( 0.6958-0.7118)                 c
c        133 S2BMSI  band 6           ( 0.7316-0.7466)                 c
c        134 S2BMSI  band 7           ( 0.7697-0.7897)                 c
c        135 S2BMSI  band 8           ( 0.7799-0.8859)                 c
c        136 S2BMSI  band 8A          ( 0.8530-0.8750)                 c
c        137 S2BMSI  band 9           ( 0.9327-0.9537)                 c
c        138 S2BMSI  band 10          ( 1.3619-1.3919)                 c
c        139 S2BMSI  band 11          ( 1.5634-1.6574)                 c
c        140 S2BMSI  band 12          ( 2.0932-2.2782)                 c
...
c**********************************************************************c
 ...
 1600 read(iread,*) wlinf,wlsup
      go to 19
   18 goto (110,111,112,112,114,114,114,114,114,114,114,114
     s      ,114,114,114,114,118,118,118,118,118,118,118,118
     s     ,121,121,121,121,121,121,127,127,127,127
     s     ,128,128,128,128,128,128,128,129,129,129,129,129
     s     ,129,129,130,130,130,130
     s     ,131,131,131,131,131,131,131,131
     s	 ,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309
     s	 ,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309,1309
     s     ,1309,1309
     s	 ,1310,1310,1310,1310,1310,1310,1310,1310,1310,1310
     s	 ,1311,1311,1311,1311,1311,1312,1312,1312,1312,1312
     s     ,1312,1312,1312,1312,1312,1312,1312,1312
     s	 ,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313
     s	 ,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313,1313
     s	 ,1313,1313
     s     ),iwave
 ...
 1113 continue
  ...
  129 call modis(iwave-41)
      goto 19
  130 call avhrr(iwave-36)
      goto 19
  131 call polder(iwave-52)
      goto 19
 1309 call GF1(iwave-60) 
	goto 19
 1310 call GF2(iwave-86) 
	goto 19
 1311 call GF4(iwave-96) 
	goto 19
 1312 call GF6(iwave-101) 
	goto 19
 1313 call Sentinel2(iwave-114)
      goto 19
...
c call os to compute downward radiation field for robar
 25   rm(-mu)=-xmuv
      ...
      rm(0)=-xmus
      spalt=1000.
      call os(tamoy,trmoy,pizmoy,tamoyp,trmoyp,spalt,
...
c call os to compute downward radiation field for robarp
      if (idatmp.ne.0) then
        ...
        rm(mu)=xmus
        rm(0)=-xmuv
        call os(tamoyp,trmoyp,pizmoy,tamoyp,trmoyp,spalt,
     s               phirad,nt,mu,np,rm,gb,rp,
     s                     xlmuv)
      endif
c
...
c**********************************************************************c
      if(ibrdf.eq.6) then
        ...
        rm(mu)=xmuv
        rm(0)=xmus
        call oceabrdf(pws,paw,xsal,pcl,wlmoy,mu,np,rm,rp,
     s           brdfints)
        rm(-mu)=2.*pi-phirad
        rm(mu)=xmus
        rm(0)=xmuv
...
c501  format(5(i10,2x))
      do 335 l=iinf,isup
        rocl(l)=brdfints(mu,1)
        roel(l)=brdfints(mu,1)
...
c**********************************************************************c
  21  read(iread,*) igroun
      if(igroun) 29,32,33
  29  read(iread,*) (rocl(i),i=iinf,isup)
      goto 36
  32  read(iread,*) ro
      do 35 l=iinf,isup
        rocl(l)=ro
